...
int tune[ ] = {NOTE_E4, NOTE_D4, NOTE_C4, NOTE_D4, NOTE_E4, NOTE_E4, NOTE_E4, NOTE_D4, NOTE_D4, NOTE_D4, NOTE_E4, NOTE_G4, NOTE_G4,
               NOTE_E4, NOTE_D4, NOTE_C4, NOTE_D4, NOTE_E4, NOTE_E4, NOTE_E4, NOTE_E4, NOTE_D4, NOTE_D4, NOTE_E4, NOTE_D4, NOTE_C4};
float duration[ ] = {QUARTER, QUARTER, QUARTER, QUARTER, QUARTER, QUARTER, HALF, QUARTER, QUARTER, HALF, QUARTER, QUARTER,  HALF,
                     QUARTER, QUARTER, QUARTER, QUARTER, QUARTER, QUARTER, QUARTER, QUARTER, QUARTER, QUARTER, QUARTER, QUARTER, WHOLE};
                     
int speed[ ] = {3500, 2500, 1500, 500};                     
int length;
 ...
 void loop() {
   for (int y=0; y<speed[y]; y++) {
     for (int x=0; x<length; x++) {
       tone(8, tune[x]);
       delay(speed[y] * duration[x]);
       noTone(8);
     }
   }
   delay(100000);
